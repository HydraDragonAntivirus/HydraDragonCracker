# HydraDragonCracker
- Inject any language dependency with this tool (Nuitka's python, C++, Rust and more)
>dumpbin /exports "D:\yenindirme\iAldazActivatorA5_windows\orig\imobiledevice-1.0.dll" > "D:\exports.txt"
>lib /def:orig.def /out:orig.lib /machine:x64
>lib /def:orig.def /out:orig86.lib /machine:x86,
>sn.exe -k key.snk
